  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/php-crud/dashboard.php" method="POST">
          <div class="modal-body">
            <input type="hidden" name="snoEdit" id="snoEdit">
            <div class="form-group">
              <label for="cname">Edit Company's Name</label>
              <input type="text" class="form-control" id="cnameEdit" name="cnameEdit" aria-describedby="emailHelp">
            </div>

            <div class="form-group">
              <label for="address">Edit Company's Address</label>
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <button class='delete btn btn-sm btn-danger' id='<?php echo $sno; ?>'>Delete</button>
          </td>
          </tr>";
        } 
          ?>
